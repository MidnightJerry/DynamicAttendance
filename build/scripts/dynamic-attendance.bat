...
@rem ##########################################################################
@rem
@rem  dynamic-attendance startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and DYNAMIC_ATTENDANCE_OPTS to pass JVM options to this script.
...
:fail
rem Set variable DYNAMIC_ATTENDANCE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%DYNAMIC_ATTENDANCE_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
